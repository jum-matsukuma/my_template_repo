...
> **Source**: [googlecolab/google-colab-cli — `skills/colab-operator/SKILL.md`](https://github.com/googlecolab/google-colab-cli/blob/main/skills/colab-operator/SKILL.md) (Apache-2.0), vendored 2026-07.
> The installed CLI always carries the current version of this reference — run `colab skill` to print it. If the CLI is installed, prefer that output over this copy; refresh this file when it drifts.
